...
def generate_wordcloud(data):
    # Menggabungkan semua deskripsi proyek ke dalam satu string
    all_descriptions = ' '.join(data['Proyek'].astype(str))
    ...
    plt.axis('off')
    plt.title('Word Cloud of Project Descriptions')
    plt.show()

# Menampilkan visualisasi kata-kata yang berpengaruh antara data riwayat proyek dan input proyek
...
if page == "Home":
    ...
    if st.button('Get Recommendation'):
        ...
        st.title("Word Cloud of Project Descriptions")
        generate_wordcloud(data)
